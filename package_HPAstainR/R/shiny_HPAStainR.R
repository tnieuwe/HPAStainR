...
shinyApp(
  ui = fluidPage(
    ...
    sidebarLayout(  
      #List of genes
      sidebarPanel("Provide a list of proteins (genes), of standard human nomenclature, and HPAStain.R will output the cell type they are most associated with based on patterns of staining in the Human Protein Atlas. Check the second tab for information on how often tissues are tested for proteins",
