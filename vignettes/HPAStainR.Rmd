...
The above function provides the most up to date information on the Human Protein Atlas website. However for more consistent results with version control, feel free to use the data from the `hpar` BioConductor package using the following commands.
